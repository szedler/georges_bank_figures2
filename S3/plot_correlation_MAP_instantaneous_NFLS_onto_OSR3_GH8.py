...
dn='/Users/sarahzedler/darwin/scripts/github/GH8/'
f=np.load(dn+'flux_of_drifters_into_OSR_SURFACE_1D.npz')
NSURb=f['NFLS1D'][:]
f.close()

f=np.load(dn+'flux_of_drifters_into_OSR_SUBSURFACE_1D.npz')
NSUBb=f['NFLS1D'][:]
f.close()

# for WCRs with R > 40km
f=np.load(dn+'MAP_LARGE_40_EDDY.npz')
MAP3b=f['MAP'][61:-500]
f.close()
...
dno='/Users/sarahzedler/darwin/scripts/github/GH8/'
fig.savefig(dno+'MAP3_NFLS_instantaneous1DB3.png')

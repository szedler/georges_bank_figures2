...
f=np.load('correlations_SURFACE.npz')
NFtime=f['FFtime'][:]
Nt=f['Nt'][:]
tyr=f['tyr'][:]
f.close()

f=np.load('correlations_cenedese_SURFACE.npz')
Nt=f['Nt'][:]
CC=f['DC'][:]
CC2=f['DC2'][:]
C0=f['D0'][:]
...
f=np.load('correlations_SUBSURFACE.npz')
NFtimeb=f['FFtime'][:]
Ntb=f['Nt'][:]
f.close()

f=np.load('correlations_cenedese_SUBSURFACE.npz')
CCb=f['DC'][:]
CCb2=f['DC2'][:]
C0b=f['D0'][:]
C1b=f['D1'][:]
...
f=np.load('confidence_intervals_SURFACE.npz')
CLO=f['CLO'][:]
CHI=f['CHI'][:]
C=f['CC'][:]
f.close()

f=np.load('confidence_intervals_SUBSURFACE.npz')
CLOb=f['CLO'][:]
CHIb=f['CHI'][:]
Cb=f['CC'][:]
f.close()
...
f=np.load('fractional_flux_SURFACE.npz')
FSUR=f['F'][:]
f.close()
